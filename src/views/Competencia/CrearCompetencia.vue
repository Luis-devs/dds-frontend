              ...
              <v-container>
                <v-row>
                  <v-col cols="7">
                    ...
                    <v-row>
                      <v-col cols="11">
                        <v-text-field label="Codigo de la Competencia" prepend-icon="mdi-key"
                    ...
                    <v-row>
                      <v-col cols="12">
                        <v-text-field label="Nombre de la Competencia" prepend-icon="mdi-key"
                ...
                <v-row>
                    <v-col cols="6">
                      <v-text-field label="Duracion (Horas)" prepend-icon="mdi-key"
