<template>
    ...
    <v-card width="700">
      ...
      >
        ...
        <v-toolbar-title>DATOS DE LA FICHA</v-toolbar-title>
              ...
              <v-card width="800">
                <v-card-text class="carta">
                    ...
                    <v-row>
                     ...
                     <v-col cols="6">
                        <v-text-field label="Nombre" prepend-icon="mdi-account" v-model="paquete.nombre"
                        :rules="camposRules"></v-text-field>
                     </v-col>
                     <v-col cols="6">
                       <v-text-field label="Apellido" prepend-icon="mdi-account" v-model="paquete.apellido"
                       :rules="camposRules"></v-text-field>
                     </v-col>
                  </v-row>
                  <v-row>
  ...
  export default {
    ...
    async mounted() {
      ...
      const instructores = await axios.get(`${url}/instructor`);
      this.instructores = instructores.data;
